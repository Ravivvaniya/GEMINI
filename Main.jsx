              ...
              <div className="main-bottom">
                  <div className="search-box">
                      ...
                      <div>
                          ...
                          <img src={assets.send_icon} alt="" onClick={()=>onSent()} onDragEnter={()=>onSent()}/>
                      </div>
                  </div>
                  <p className='bottom-info'>Gemini may display ifo, including about people, so double-check its responses. Your privacy and Gemini Apps</p>
              </div>
          </div>
    </div>
  )
